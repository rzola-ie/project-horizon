...
export default class EyeBulge {
  ...
  initFaceFilter(bestVideoSettings) {
    JEELIZFACEFILTER.init({
      canvasId: this.canvasId,
      NNCPath: '../horizon-simulator/neuralNets/', // path to JSON neural network model (NN_DEFAULT.json by default)
  ...
  initThreeScene(spec) {
    ...
    */
    maskLoader.load('/horizon-simulator/models/face.json', (geometry) => {
